...
impl acpi::Handler for KernelAcpiHandler {
    ...
    fn read_pci_u8(&self, _: acpi::PciAddress, _: u16) -> u8 {
        u8::MAX
    }
    fn read_pci_u16(&self, _: acpi::PciAddress, _: u16) -> u16 {
        u16::MAX
    }
    fn read_pci_u32(&self, _: acpi::PciAddress, _: u16) -> u32 {
        u32::MAX
    }
    ...
    fn acquire(&self, _: acpi::Handle, _: u16) -> Result<(), acpi::aml::AmlError> {
        Ok(())
    }
