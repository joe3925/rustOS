...
use kernel_api::kernel_types::dma::DMA_PCI_IDENTITY_FLAG_BUS_MASTER_CAPABLE;
use kernel_api::kernel_types::dma::DMA_PCI_IDENTITY_FLAG_BUS_MASTER_ENABLED;
use kernel_api::kernel_types::dma::DmaPciDeviceIdentity;
