...
impl PagingPlatform for Aarch64Platform {
    ...
    fn resolve_mapping(_virt: VirtAddr) -> Option<ResolvedMapping> {
        todo!()
    }
    fn resolve_mapping_in_root(_root: Self::Root, _virt: VirtAddr) -> Option<ResolvedMapping> {
        todo!()
    }
    fn local_flush_tlb_all() {
        todo!()
    }
    fn local_flush_tlb_range(_start: VirtAddr, _size: u64, _stride: u64) {
        todo!()
    }
