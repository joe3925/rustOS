...
use kernel_abi::arch::Aarch64PeTlsDirectory;
...
fn pe_tls_raw_data_size(directory: &Aarch64PeTlsDirectory) -> usize {
...
fn pe_tls_alignment(directory: &Aarch64PeTlsDirectory) -> usize {
    match (directory.characteristics >> 20) & 0xF {
        0x0 | 0x1 => 1,
        0x2 => 2,
        0x3 => 4,
        0x4 => 8,
