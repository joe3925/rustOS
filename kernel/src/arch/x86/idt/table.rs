...
use super::super::drivers::timer_driver::timer_interrupt_entry;
use super::super::exception_handlers::exception_handlers;
use super::super::gdt::{
...
fn init_idt() -> InterruptDescriptorTable {
    ...
    unsafe {
        idt.divide_error.set_handler_addr(exception_handler_addr(
            exception_handlers::divide_by_zero_fault,
        ));
        idt.debug
            .set_handler_addr(exception_handler_addr(exception_handlers::debug_exception));
        idt.non_maskable_interrupt
            .set_handler_addr(exception_handler_addr(
                exception_handlers::non_maskable_interrupt,
            ));
        idt.breakpoint
            .set_handler_addr(exception_handler_addr(
                exception_handlers::breakpoint_exception,
            ))
            .set_privilege_level(x86_64::PrivilegeLevel::Ring3);
        idt.overflow.set_handler_addr(exception_handler_addr(
            exception_handlers::overflow_exception,
        ));
        idt.bound_range_exceeded
            .set_handler_addr(exception_handler_addr(
                exception_handlers::bound_range_exceeded_exception,
            ));
        idt.invalid_opcode.set_handler_addr(exception_handler_addr(
            exception_handlers::invalid_opcode_exception,
        ));
        idt.device_not_available
            .set_handler_addr(exception_handler_addr(
                exception_handlers::device_not_available_exception,
            ));
        idt.double_fault
            .set_handler_addr(exception_handler_addr(exception_handlers::double_fault))
            .set_stack_index(DOUBLE_FAULT_IST_INDEX);
        idt.invalid_tss.set_handler_addr(exception_handler_addr(
            exception_handlers::invalid_tss_exception,
        ));
        idt.segment_not_present
            .set_handler_addr(exception_handler_addr(
                exception_handlers::segment_not_present_exception,
            ));
        idt.stack_segment_fault
            .set_handler_addr(exception_handler_addr(
                exception_handlers::stack_segment_fault,
            ));
        idt.general_protection_fault
            .set_handler_addr(exception_handler_addr(
                exception_handlers::general_protection_fault,
            ));
        idt.page_fault
            .set_handler_addr(exception_handler_addr(exception_handlers::page_fault))
            .set_stack_index(PAGE_FAULT_IST_INDEX);
        idt.x87_floating_point
            .set_handler_addr(exception_handler_addr(
                exception_handlers::x87_floating_point_exception,
            ));
        idt.alignment_check.set_handler_addr(exception_handler_addr(
            exception_handlers::alignment_check_exception,
        ));
        idt.machine_check.set_handler_addr(exception_handler_addr(
            exception_handlers::machine_check_exception,
        ));
        idt.simd_floating_point
            .set_handler_addr(exception_handler_addr(
                exception_handlers::simd_floating_point_exception,
            ));
        idt.virtualization.set_handler_addr(exception_handler_addr(
            exception_handlers::virtualization_exception,
        ));
    }
