...
use crate::memory::paging::map::commit_heap_range;
...
pub(crate) fn init_heap() {
    ...
    let heap_size = {
        let reserved_heap_size =
            align_up_to_base_page(boot_usable_bytes()).expect("invalid platform base page size");
    ...
    unsafe {
        commit_heap_range(heap_start.into(), heap_size, flags, false)
