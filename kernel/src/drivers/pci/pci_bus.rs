...
impl PciBus {
    pub fn new() -> Self {
        let mut pci = PciBus {
            device_collection: DeviceCollection::new(),
            last_update: 0,
        };
            ...
            for device in 0..32 {
                for function in 0..8 {
                    ...
                    if id != 0xFFFFFFFF {
                        ...
                        let header = PciBus::pci_config_read(
                            bus,
                            device,
                            function,
                            0x08,
                        ...
                        pci.device_collection.add_device(Device::new(
                            bus, device, function, id, class_code, subclass,
                        ));
                    }
                }
            }
